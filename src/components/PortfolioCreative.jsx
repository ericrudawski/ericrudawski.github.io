    ...
    <>
          ...
          <div className="tokyo_tm_portfolio">
            <div className="tokyo_tm_title">
              <div className="title_flex">
                <div className="left">
                  <span>Portfolio</span>
                  <h3>Things I've Worked On
                  </h3>
                  <p>more text about the portfolio will go here. like how I use skills, etc</p>
                </div>
              </div>
            </div>
            {/* END TOKYO_TM_TITLE */}
                    ...
                    <ul className="portfolio_list">
                      ...
                      >
                        <div className="inner">
                          <div className="entry tokyo_tm_portfolio_animation_wrap">
                            <img
                              src="assets/img/portfolio/G2G1.png"
                              alt="Details"
                              data-tip
                              data-for="detail"
      ...
      >
        <div className="tokyo_tm_modalbox_news portfolio_tm_modalbox">
          ...
          {/* END CLOSE ICON */}
          {/* ------------------------------------------------------------
                START OF Excel / PowerQuery - G2G REPORT
                ------------------------------------------------------------ */}
            ...
            <div className="description_wrap scrollable">
              <div className="image">
                ...
                <div
                  className="main"
                  style={{
                    backgroundImage: "url(assets/img/portfolio/G2G1.png)",
                  }}
                ></div>
              </div>
              {/* END IMAGE */}
              ...
              <div className="main_details">
                <div className="textbox">
                  <p>
                    <b>What happened: </b>We live in a world where we need to move quickly and iterate
                  ...
                  <p>
                  <b>What I did about it: </b>Mockups are useful both for the creative phase of the
                  ...
                  <p>
                  <b>What helped me: </b>I learned the majority of my power query abilities 
                    ...
                    <div className="list_inner">
                      <div className="my_image">
                        ...
                        <div
                          className="main"
                          style={{
                            backgroundImage: "url(assets/img/portfolio/G2G2.png)",
                          }}
                        ></div>
                      </div>
                    </div>
                    ...
                    <div className="list_inner">
                      <div className="my_image">
                        ...
                        <div
                          className="main"
                          style={{
                            backgroundImage: "url(assets/img/portfolio/G2G3.jpeg)",
                          }}
                        ></div>
                      </div>
                    </div>
                    ...
                    <div className="list_inner">
                      <div className="my_image">
                        ...
                        <div
                          className="main"
                          style={{
                            backgroundImage: "url(assets/img/portfolio/G2G4.jpeg)",
                          }}
                        ></div>
                      </div>
                    </div>
